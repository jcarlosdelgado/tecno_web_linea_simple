...
const imagePreview = ref(props.servicio.imagen ? `/storage/${props.servicio.imagen}` : null);
                        ...
                        <div>
                            ...
                            <div class="mt-1 flex items-center gap-4">
                                <div class="flex-1">
                                    ...
                                    />
                                    <p class="mt-1 text-xs text-gray-500">Deja vacío para mantener la imagen actual</p>
                                </div>
